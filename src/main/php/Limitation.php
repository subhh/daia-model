...
final class Limitation extends Entity
{
    final public function equals (Limitation $other) : bool
    {
        if ($this->getId() && $other->getId()) {
            if ((string)$this->getId() === (string)$other->getId()) {
                return true;
            }
            return false;
        }
        if ($this->getId() === null && $other->getId() === null) {
            if ((string)$this->getHref() === (string)$other->getHref() &&
                (string)$this->getContent() === (string)$other->getContent()) {
                return true;
            }
            return false;
        }
